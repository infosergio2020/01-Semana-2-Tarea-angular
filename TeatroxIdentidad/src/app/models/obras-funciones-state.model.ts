...
export type ObrasFuncionesActions = NuevaObraAction | ElegidoFavoritoAction | VoteUpAction | VoteDownAction | InitMyDataAction; //esto termina siendo como una variable que contiene un conjunto de tipos de datos que son acciones sobre Obras Funciones
